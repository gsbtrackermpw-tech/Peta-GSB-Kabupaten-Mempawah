...
var group_coba = new ol.layer.Group({
                                layers: [],
                                fold: 'close',
                                title: 'coba'});
var group_LayerGSBold = new ol.layer.Group({
                                layers: [],
                                fold: 'open',
                                title: 'Layer GSB old'});
...
lyr_JalanKabupaten_2.set('fieldAliases', {'Nm_Ruas': 'Nama Ruas Jalan', 'Nomor': 'Nomor', 'Garis_Semp': 'Garis Sempadan Bangunan', 'Garis_Se_1': 'Garis Sempadan Pagar', 'Foto_1': 'Foto', });
